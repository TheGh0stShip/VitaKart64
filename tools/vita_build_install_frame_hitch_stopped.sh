...
export VITAKART_FRAME_HITCH_LOG=1
export VITAKART_FRAME_HITCH_LOG_MS="${VITAKART_FRAME_HITCH_LOG_MS:-18}"
export VITAKART_TEXTURE_MISS_LOG=0
export VITAKART_ALLOW_DIAGNOSTIC_BUILD=1
...
make -B -f Makefile.vita -j"$JOBS" vita-kart-64.vpk
