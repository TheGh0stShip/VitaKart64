...
class GfxRenderingAPI {
  public:
    ...
    virtual void ReserveTextureSlots(uint32_t) {}
    ...
    virtual bool UploadTextureRgba16(const uint16_t*, uint32_t, uint32_t) { return false; }
    virtual void InvalidateTextureBindings() {}
